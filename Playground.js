...
var author$project$Interpreter$setScalar = F3(
	function (name, value, state) {
		return _Utils_update(
			state,
			{
				scalars: A3(elm$core$Dict$insert, name, value, state.scalars)
			});
	});
		...
		return _Utils_update(
			state,
			{
				functions: A3(
					...
					name,
					_Utils_Tuple2(param, body),
					state.functions)
			});
	});
var author$project$Interpreter$setMapFunction = F5(
	function (name, param, index, body, state) {
		return _Utils_update(
			state,
			{
				mapFunctions: A3(
					elm$core$Dict$insert,
					name,
					_Utils_Tuple3(param, index, body),
					state.mapFunctions)
			});
	});
var author$project$Interpreter$setVector = F3(
	function (name, value, state) {
		return _Utils_update(
			state,
			{
				vectors: A3(elm$core$Dict$insert, name, value, state.vectors)
			});
	});
var author$project$Return$Error = function (a) {
	return {$: 'Error', a: a};
};
var author$project$Return$Expression = function (a) {
	return {$: 'Expression', a: a};
};
var author$project$Return$Void = {$: 'Void'};
var elm$parser$Parser$Problem = function (a) {
	return {$: 'Problem', a: a};
};
var author$project$Return$throwError = function (error) {
	return author$project$Return$Error(
		{
			col: 0,
			problem: elm$parser$Parser$Problem(error),
			row: 0
		});
};
var author$project$Return$andThen = F2(
	function (fn, val) {
		switch (val.$) {
			case 'Expression':
				var e = val.a;
			...
			case 'Error':
				var e = val.a;
				return author$project$Return$Error(e);
			default:
				return author$project$Return$throwError('Void return inside another expression');
		}
	});
var author$project$Return$andThenNum = F2(
	function (builder, fn) {
			...
			function (expr) {
				switch (expr.$) {
					case 'Number':
						...
						return fn(_float);
					case 'Vector':
						return author$project$Return$throwError('Cannot apply function to vector');
					default:
						var other = expr;
...
var author$project$Return$andThen2 = F3(
	function (fn, val, val2) {
		var _n0 = _Utils_Tuple2(val, val2);
		_n0$2:
		while (true) {
			_n0$3:
			while (true) {
				switch (_n0.a.$) {
					case 'Expression':
						switch (_n0.b.$) {
							...
							default:
								var _n2 = _n0.b;
								return author$project$Return$throwError('Cannot apply void to function');
						}
					case 'Error':
						return val;
					default:
			...
			var _n1 = _n0.a;
			return author$project$Return$throwError('Cannot apply function to void');
		}
		return val2;
	});
...
var author$project$Return$andThenNum2 = F2(
	function (builder, fn) {
		return author$project$Return$andThen2(
			F2(
				function (expr1, expr2) {
					var _n0 = _Utils_Tuple2(expr1, expr2);
					if (_n0.a.$ === 'Number') {
						if (_n0.b.$ === 'Number') {
							var float1 = _n0.a.a;
							var float2 = _n0.b.a;
							return A2(fn, float1, float2);
						} else {
							var float1 = _n0.a.a;
							var e = _n0.b;
							return author$project$Return$Expression(
								A2(
									builder,
									author$project$Types$Number(float1),
									e));
						}
					} else {
						if (_n0.b.$ === 'Number') {
							...
							return author$project$Return$Expression(
								A2(
									builder,
									e,
									author$project$Types$Number(float2)));
						} else {
							var e1 = _n0.a;
							var e2 = _n0.b;
							return author$project$Return$Expression(
...
var author$project$Return$andThenVector = F2(
	function (builder, fn) {
		return author$project$Return$andThen(
			function (expr) {
				switch (expr.$) {
					case 'Number':
						var _float = expr.a;
						return author$project$Return$throwError('Vector expected');
					case 'Vector':
						var items = expr.a;
						return fn(items);
					default:
...
var author$project$Return$mapNum = F2(
	function (builder, fn) {
		return A2(
			author$project$Return$andThenNum,
			builder,
			A2(
				elm$core$Basics$composeR,
				fn,
				A2(elm$core$Basics$composeR, author$project$Types$Number, author$project$Return$Expression)));
	});
var author$project$Return$mapNum2 = F2(
	function (builder, fn) {
		return A2(
...
var author$project$Types$DoubleArity = F3(
	function (a, b, c) {
		return {$: 'DoubleArity', a: a, b: b, c: c};
	});
var author$project$Types$Index = {$: 'Index'};
var author$project$Types$MapAbstraction = F3(
	function (a, b, c) {
		return {$: 'MapAbstraction', a: a, b: b, c: c};
	});
var author$project$Types$SingleArity = F2(
	function (a, b) {
		return {$: 'SingleArity', a: a, b: b};
	});
var author$project$Types$TripleArity = F4(
	function (a, b, c, d) {
		return {$: 'TripleArity', a: a, b: b, c: c, d: d};
	});
var author$project$Types$Variable = function (a) {
	return {$: 'Variable', a: a};
};
var author$project$Types$Vector = function (a) {
	return {$: 'Vector', a: a};
};
var author$project$Types$VectorIdentifier = function (a) {
	return {$: 'VectorIdentifier', a: a};
};
			...
			return A3(
				...
				function (param_) {
					return A2(
						...
						A3(author$project$Interpreter$setScalar, paramName, param_, state),
						functionBody);
				},
				A2(author$project$Interpreter$eval, state, args));
		} else {
			var paramName = functionParam.a;
			return A3(
				...
				function (param_) {
					return A2(
						author$project$Interpreter$eval,
						A3(author$project$Interpreter$setVector, paramName, param_, state),
						functionBody);
				},
				A2(author$project$Interpreter$eval, state, args));
		}
			...
			function (items) {
				return A3(
					...
					author$project$Return$Expression(
						author$project$Types$Vector(_List_Nil)),
					items);
			},
			A2(author$project$Interpreter$eval, state, args));
	});
var author$project$Interpreter$eval = function (state) {
	return A2(
		elm$core$Basics$composeR,
...
var author$project$Interpreter$runDoubleArity = F4(
	function (state, func, e1, e2) {
		...
		switch (func.$) {
			case 'Addition':
				return numOp(elm$core$Basics$add);
			case 'Subtraction':
				return numOp(elm$core$Basics$sub);
			case 'Multiplication':
				return numOp(elm$core$Basics$mul);
			case 'Division':
			...
			default:
				var vector = function () {
					if ((e1.$ === 'Variable') && (e1.a.$ === 'ScalarIdentifier')) {
						var name = e1.a.a;
						return author$project$Types$Variable(
							author$project$Types$VectorIdentifier(name));
					} else {
						return e1;
					}
				}();
				return A3(
					author$project$Return$andThenVector,
					function (v) {
						return A3(author$project$Types$DoubleArity, author$project$Types$Index, v, e2);
					},
					function (items) {
						return A3(
							author$project$Return$andThenNum,
							...
							function (index) {
								if ((!_Utils_eq(
									...
									if (_n17.$ === 'Just') {
										...
										return author$project$Return$throwError(
											'Index ' + (elm$core$String$fromFloat(index) + ' out of bounds'));
									}
								}
							},
							A2(author$project$Interpreter$eval, state, e2));
		...
		switch (expr.$) {
			case 'Number':
				...
				return _Utils_Tuple2(
					state,
					author$project$Return$Expression(
						author$project$Types$Number(val)));
			case 'Vector':
				var items = expr.a;
			...
			case 'Variable':
				...
				if (identifier.$ === 'ScalarIdentifier') {
					...
					return _Utils_Tuple2(
						...
						A2(
							...
							A2(
								elm$core$Maybe$map,
								A2(elm$core$Basics$composeL, author$project$Return$Expression, author$project$Types$Vector),
								A2(elm$core$Dict$get, name, state.vectors))));
				}
			case 'Abstraction':
				var param = expr.a;
				var body = expr.b;
			...
			case 'SingleArity':
				var func = expr.a;
				var e = expr.b;
				return A3(author$project$Interpreter$runSingleArity, state, func, e);
			case 'DoubleArity':
				var func = expr.a;
				var e1 = expr.b;
				var e2 = expr.c;
...
var author$project$Interpreter$runSingleArity = F3(
	function (state, func, expr) {
		switch (func.$) {
			case 'Assignment':
				var identifier = func.a;
				if (identifier.$ === 'ScalarIdentifier') {
					var name = identifier.a;
					var _n4 = A2(author$project$Interpreter$eval, state, expr);
					switch (_n4.$) {
						case 'Void':
							return _Utils_Tuple2(
								state,
								author$project$Return$throwError('Cannot set variable ' + (name + ' to void')));
						case 'Error':
							var error = _n4.a;
							return _Utils_Tuple2(
								state,
								author$project$Return$Error(error));
						default:
							switch (_n4.a.$) {
								case 'Number':
									var num = _n4.a.a;
								...
								case 'Vector':
									return _Utils_Tuple2(
										state,
										author$project$Return$throwError('Cannot assign vector to scalar variables, use \\vec{' + (name + '} instead')));
								case 'Abstraction':
									var _n5 = _n4.a;
									var params = _n5.a;
									var body = _n5.b;
									return _Utils_Tuple2(
										A4(author$project$Interpreter$setFunction, name, params, body, state),
										author$project$Return$Void);
								case 'MapAbstraction':
									var _n6 = _n4.a;
									var params = _n6.a;
									...
									var body = _n6.c;
									return _Utils_Tuple2(
										A5(author$project$Interpreter$setMapFunction, name, params, index, body, state),
										author$project$Return$Void);
								default:
									var e = _n4.a;
									return _Utils_Tuple2(
										...
										author$project$Return$Expression(
											A2(
												author$project$Types$SingleArity,
												author$project$Types$Assignment(identifier),
												e)));
							}
					}
				} else {
					var name = identifier.a;
					var _n7 = A2(author$project$Interpreter$eval, state, expr);
					switch (_n7.$) {
						case 'Void':
							return _Utils_Tuple2(
								state,
						...
						default:
							switch (_n7.a.$) {
								case 'Number':
									return _Utils_Tuple2(
										state,
										author$project$Return$throwError('Cannot assign scalar to vector variables'));
								case 'Vector':
									var v = _n7.a.a;
									return _Utils_Tuple2(
			...
			case 'Application':
				var e1 = func.a;
				var _n8 = A2(author$project$Interpreter$eval, state, e1);
				if (((_n8.$ === 'Expression') && (_n8.a.$ === 'Variable')) && (_n8.a.a.$ === 'ScalarIdentifier')) {
					var name = _n8.a.a.a;
					return _Utils_Tuple2(
						state,
						function () {
							var _n9 = _Utils_Tuple2(
								A2(elm$core$Dict$get, name, state.mapFunctions),
								A2(elm$core$Dict$get, name, state.functions));
							if (_n9.a.$ === 'Just') {
								var mapFn = _n9.a.a;
								return A4(author$project$Interpreter$callMapFunction, func, state, expr, mapFn);
							} else {
								if (_n9.b.$ === 'Just') {
									var _n10 = _n9.a;
									var fn = _n9.b.a;
									return A4(author$project$Interpreter$callFunction, func, state, expr, fn);
								} else {
									var _n11 = _n9.a;
									var _n12 = _n9.b;
									return A3(
...
var author$project$Interpreter$runTripleArity = F5(
	function (state, func, expr1, expr2, expr3) {
		var identifier = func.a;
		var iterate = F2(
			function (curr, total) {
				var state_ = A3(author$project$Interpreter$setScalar, identifier, curr, state);
				return A4(
					author$project$Return$mapNum2,
					function (_n1) {
						return A3(author$project$Types$TripleArity, func, expr1, expr2);
					},
					F2(
						function (result, total_) {
							return total_ + result;
						}),
					total,
					A2(author$project$Interpreter$eval, state_, expr3));
			});
		var forLoop = F2(
			function (lowerLimit, upperLimit) {
				return (!_Utils_eq(
					...
					A2(
						elm$core$List$range,
						elm$core$Basics$round(lowerLimit),
						elm$core$Basics$round(upperLimit))));
			});
		return A4(
			author$project$Return$andThenNum2,
			F2(
				function (e1, e2) {
					return A4(author$project$Types$TripleArity, func, e1, e2, expr3);
				}),
			forLoop,
...
var author$project$MathParser$digits = elm$parser$Parser$number(
	{
		binary: elm$core$Maybe$Nothing,
		_float: elm$core$Maybe$Just(author$project$Types$Number),
...
var author$project$MathParser$vectorIdentifier = A2(
	...
	A2(
		...
		elm$parser$Parser$oneOf(
			_List_fromArray(
				[
					elm$parser$Parser$symbol('\\vec'),
					elm$parser$Parser$symbol('\\mathbf')
				]))),
	Punie$elm_parser_extras$Parser$Extras$braces(author$project$MathParser$scalarIdentifier));
var author$project$Types$ScalarIdentifier = function (a) {
	return {$: 'ScalarIdentifier', a: a};
};
...
var author$project$MathParser$identifier = elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2(elm$parser$Parser$map, author$project$Types$ScalarIdentifier, author$project$MathParser$scalarIdentifier),
			A2(elm$parser$Parser$map, author$project$Types$VectorIdentifier, author$project$MathParser$vectorIdentifier)
		]));
var author$project$MathParser$atoms = elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2(elm$parser$Parser$map, author$project$Types$Variable, author$project$MathParser$identifier),
			author$project$MathParser$digits
		]));
var author$project$Types$Factorial = {$: 'Factorial'};
var author$project$MathParser$factorial = function (expr) {
	return A2(
		elm$parser$Parser$ignorer,
		elm$parser$Parser$succeed(
			A2(author$project$Types$SingleArity, author$project$Types$Factorial, expr)),
...
var Punie$elm_parser_extras$Parser$Expression$unaryOp = F2(
	function (fn, opParser) {
		return A2(
			elm$parser$Parser$ignorer,
			A2(
...
var Punie$elm_parser_extras$Parser$Expression$prefixOperator = F2(
	function (fn, opParser) {
...
var author$project$MathParser$operators = function () {
	...
	var infixOp = function (op) {
		return Punie$elm_parser_extras$Parser$Expression$infixOperator(
			author$project$Types$DoubleArity(op));
	};
	return _List_fromArray(
		[
			_List_fromArray(
			[
				A2(
				Punie$elm_parser_extras$Parser$Expression$prefixOperator,
				author$project$Types$SingleArity(author$project$Types$Negation),
				elm$parser$Parser$symbol('-'))
			]),
			_List_fromArray(
			[
...
var author$project$Types$Frac = {$: 'Frac'};
...
var author$project$Types$doubleAritySymbolsMap = elm$core$Dict$fromList(
	_List_fromArray(
		[
...
var author$project$MathParser$exponentiation = function (expr) {
	return A2(
		elm$parser$Parser$keeper,
		A2(
			elm$parser$Parser$ignorer,
			A2(
				...
				A2(
					elm$parser$Parser$ignorer,
					elm$parser$Parser$succeed(
						A2(author$project$Types$DoubleArity, author$project$Types$Exponentiation, expr)),
					elm$parser$Parser$backtrackable(elm$parser$Parser$spaces)),
				elm$parser$Parser$backtrackable(
					elm$parser$Parser$symbol('^'))),
			elm$parser$Parser$backtrackable(elm$parser$Parser$spaces)),
		elm$parser$Parser$backtrackable(
			Punie$elm_parser_extras$Parser$Extras$braces(
				elm$parser$Parser$lazy(
					function (_n9) {
						return author$project$MathParser$cyclic$expression();
					}))));
};
var author$project$MathParser$expressionParsers = function (withDeclarations) {
	...
	var declarations = _List_fromArray(
		[
			author$project$MathParser$cyclic$mapFunctionDeclaration(),
			author$project$MathParser$cyclic$functionDeclaration(),
			author$project$MathParser$cyclic$assignment()
		]);
	return withDeclarations ? elm$parser$Parser$oneOf(
		_Utils_ap(declarations, expressions)) : elm$parser$Parser$oneOf(expressions);
};
var author$project$MathParser$expression_ = function (withDeclarations) {
	return A2(
		Punie$elm_parser_extras$Parser$Expression$buildExpressionParser,
		author$project$MathParser$operators,
		elm$parser$Parser$lazy(
			function (_n7) {
				return A2(
					elm$parser$Parser$andThen,
					function (expr) {
						return elm$parser$Parser$oneOf(
							_List_fromArray(
								[
									author$project$MathParser$index(expr),
									author$project$MathParser$exponentiation(expr),
									author$project$MathParser$factorial(expr),
									elm$parser$Parser$succeed(expr)
								]));
					},
					author$project$MathParser$expressionParsers(withDeclarations));
			}));
};
var author$project$MathParser$index = function (expr) {
	return A2(
		elm$parser$Parser$keeper,
		A2(
			elm$parser$Parser$ignorer,
			elm$parser$Parser$succeed(
				A2(author$project$Types$DoubleArity, author$project$Types$Index, expr)),
			elm$parser$Parser$backtrackable(
...
function author$project$MathParser$cyclic$assignment() {
	return A2(
		elm$parser$Parser$keeper,
		A2(
			elm$parser$Parser$keeper,
			elm$parser$Parser$succeed(
				A2(elm$core$Basics$composeL, author$project$Types$SingleArity, author$project$Types$Assignment)),
			A2(
				elm$parser$Parser$ignorer,
				A2(
					elm$parser$Parser$ignorer,
					A2(
						elm$parser$Parser$ignorer,
						elm$parser$Parser$backtrackable(author$project$MathParser$identifier),
						elm$parser$Parser$backtrackable(elm$parser$Parser$spaces)),
					elm$parser$Parser$symbol('=')),
				elm$parser$Parser$spaces)),
...
function author$project$MathParser$cyclic$vectors() {
	return A2(
		elm$parser$Parser$keeper,
		elm$parser$Parser$succeed(author$project$Types$Vector),
		elm$parser$Parser$sequence(
			{
				end: ')',
				item: author$project$MathParser$cyclic$expression(),
				separator: ',',
...
function author$project$MathParser$cyclic$mapFunctionDeclaration() {
	return A2(
		elm$parser$Parser$keeper,
		A2(
			elm$parser$Parser$keeper,
			A2(
				...
				A2(
					...
					elm$parser$Parser$succeed(
						F4(
							function (name, param, idx, body) {
								return A2(
									author$project$Types$SingleArity,
									author$project$Types$Assignment(
										author$project$Types$ScalarIdentifier(name)),
									A3(author$project$Types$MapAbstraction, param, idx, body));
							})),
					elm$parser$Parser$backtrackable(author$project$MathParser$scalarIdentifier)),
				A2(
					elm$parser$Parser$ignorer,
					elm$parser$Parser$backtrackable(
						Punie$elm_parser_extras$Parser$Extras$parens(author$project$MathParser$vectorIdentifier)),
					elm$parser$Parser$backtrackable(
						elm$parser$Parser$symbol('_')))),
			A2(
				elm$parser$Parser$ignorer,
...
function author$project$MathParser$cyclic$functionDeclaration() {
	return A2(
		elm$parser$Parser$keeper,
		A2(
			elm$parser$Parser$keeper,
			...
			A2(
				...
				A2(
					...
					A2(
						elm$parser$Parser$ignorer,
						elm$parser$Parser$backtrackable(
							Punie$elm_parser_extras$Parser$Extras$parens(author$project$MathParser$identifier)),
						elm$parser$Parser$backtrackable(elm$parser$Parser$spaces)),
					elm$parser$Parser$backtrackable(
						elm$parser$Parser$symbol('='))),
				elm$parser$Parser$spaces)),
...
function author$project$MathParser$cyclic$functionCall() {
	return A2(
		elm$parser$Parser$keeper,
		A2(
			elm$parser$Parser$keeper,
			elm$parser$Parser$succeed(
				A2(
					...
					A2(
						elm$core$Basics$composeL,
						A2(elm$core$Basics$composeL, author$project$Types$SingleArity, author$project$Types$Application),
						author$project$Types$Variable),
					author$project$Types$ScalarIdentifier)),
			elm$parser$Parser$backtrackable(author$project$MathParser$scalarIdentifier)),
		elm$parser$Parser$backtrackable(
			Punie$elm_parser_extras$Parser$Extras$parens(
				author$project$MathParser$cyclic$expression())));
}
function author$project$MathParser$cyclic$expression() {
	return author$project$MathParser$expression_(false);
}
function author$project$MathParser$cyclic$symbolicFunction() {
	var findSymbols = function (name) {
		return _Utils_Tuple3(
			A2(elm$core$Dict$get, name, author$project$Types$singleAritySymbolsMap),
			A2(elm$core$Dict$get, name, author$project$Types$doubleAritySymbolsMap),
			A2(elm$core$Dict$get, name, author$project$Types$tripleAritySymbolsMap));
	};
	var matchArities = function (name) {
		var _n0 = findSymbols(name);
		if (_n0.a.$ === 'Just') {
			var symbol = _n0.a.a;
			return A2(
				elm$parser$Parser$keeper,
				elm$parser$Parser$succeed(
					author$project$Types$SingleArity(symbol)),
				Punie$elm_parser_extras$Parser$Extras$braces(
					author$project$MathParser$cyclic$expression()));
		} else {
			if (_n0.b.$ === 'Just') {
				...
				return A2(
					...
					A2(
						elm$parser$Parser$keeper,
						elm$parser$Parser$succeed(
							author$project$Types$DoubleArity(symbol)),
						Punie$elm_parser_extras$Parser$Extras$braces(
							author$project$MathParser$cyclic$expression())),
					Punie$elm_parser_extras$Parser$Extras$braces(
						author$project$MathParser$cyclic$expression()));
			} else {
				if ((_n0.c.$ === 'Just') && (_n0.c.a === 'sum_')) {
					var _n2 = _n0.a;
					var _n3 = _n0.b;
					var scalarAssignment = A2(
						elm$parser$Parser$keeper,
						A2(
							elm$parser$Parser$keeper,
							elm$parser$Parser$succeed(
								A2(elm$core$Basics$composeL, author$project$Types$TripleArity, author$project$Types$Sum_)),
							A2(
								elm$parser$Parser$ignorer,
								A2(
									elm$parser$Parser$ignorer,
					...
					return A2(
						...
						A2(
							...
							A2(
								...
								A2(
									elm$parser$Parser$ignorer,
									Punie$elm_parser_extras$Parser$Extras$braces(scalarAssignment),
									elm$parser$Parser$symbol('^'))),
							A2(
								elm$parser$Parser$ignorer,
								Punie$elm_parser_extras$Parser$Extras$braces(
					...
					var _n4 = _n0.a;
					var _n5 = _n0.b;
					return elm$parser$Parser$problem('could not find symbol ' + name);
				}
			}
		}
	};
	return A2(
		...
		A2(
			...
			elm$parser$Parser$succeed(elm$core$Basics$identity),
			elm$parser$Parser$symbol('\\')),
		A2(elm$parser$Parser$andThen, matchArities, author$project$MathParser$symbolIdentifier));
}
try {
	var author$project$MathParser$assignment = author$project$MathParser$cyclic$assignment();
	...
	var author$project$MathParser$mapFunctionDeclaration = author$project$MathParser$cyclic$mapFunctionDeclaration();
	author$project$MathParser$cyclic$mapFunctionDeclaration = function () {
		return author$project$MathParser$mapFunctionDeclaration;
	};
	var author$project$MathParser$functionDeclaration = author$project$MathParser$cyclic$functionDeclaration();
	author$project$MathParser$cyclic$functionDeclaration = function () {
		return author$project$MathParser$functionDeclaration;
	};
	var author$project$MathParser$functionCall = author$project$MathParser$cyclic$functionCall();
	author$project$MathParser$cyclic$functionCall = function () {
		return author$project$MathParser$functionCall;
	};
	var author$project$MathParser$expression = author$project$MathParser$cyclic$expression();
	author$project$MathParser$cyclic$expression = function () {
		return author$project$MathParser$expression;
	};
	var author$project$MathParser$symbolicFunction = author$project$MathParser$cyclic$symbolicFunction();
	author$project$MathParser$cyclic$symbolicFunction = function () {
...
var author$project$MathParser$parse = function (string) {
	return A2(elm$parser$Parser$run, author$project$MathParser$program, string + '\nEOF');
};
var author$project$Playground$Routes$Playground = {$: 'Playground'};
var author$project$Playground$Routes$About = {$: 'About'};
...
var author$project$Playground$Routes$mapFragment = F2(
	function (page, path) {
		return A2(
			elm$url$Url$Parser$map,
			function (frag) {
				return _Utils_eq(
					A2(elm$core$Maybe$withDefault, '', frag),
					path) ? page : author$project$Playground$Routes$Playground;
			},
...
var author$project$Playground$Routes$routes = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2(author$project$Playground$Routes$mapFragment, author$project$Playground$Routes$About, 'about'),
					...
					return _Utils_Tuple2(
						...
						A2(
							...
							elm$browser$Browser$Dom$focus(
								'cellinput-' + elm$core$String$fromInt(index))));
				case 'RunCell':
					var getLastResult = function (res) {
						if (res.$ === 'Ok') {
							var values = res.a;
							return elm_community$list_extra$List$Extra$last(values);
						} else {
							var errs = res.a;
							return A2(
								elm$core$Maybe$map,
								function (e) {
									return _Utils_Tuple2(
										model.state,
										author$project$Return$Error(e));
								},
								elm_community$list_extra$List$Extra$last(errs));
						}
					};
					var runCell = function (cell_) {
						return elm$core$String$isEmpty(
							elm$core$String$trim(cell_.input)) ? elm$core$Maybe$Nothing : getLastResult(
							A2(
								elm$core$Result$andThen,
								author$project$Interpreter$run(model.state),
								author$project$MathParser$parse(cell_.input)));
					};
					var result = A2(
						elm$core$Maybe$withDefault,
						_Utils_Tuple2(model.state, author$project$Return$Void),
						A2(
					...
					var updateCell = function (cell_) {
						return _Utils_update(
							cell_,
							{
								result: elm$core$Maybe$Just(result.b)
							});
					};
					var updated = A2(
						author$project$Playground$update,
...
var author$project$Playground$Style$submenu = _List_fromArray(
	[
...
var author$project$Playground$Style$utf8Icon = _List_fromArray(
	[
		A2(elm$html$Html$Attributes$style, 'font-size', '0.8em')
	]);
var author$project$Playground$Types$Basics = {$: 'Basics'};
var author$project$Playground$Types$Bitcoin = {$: 'Bitcoin'};
var author$project$Playground$Types$ClearPlayground = {$: 'ClearPlayground'};
var author$project$Playground$Types$SetExample = function (a) {
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Evaluate LaTeX math code (beta)')
							]))
					])),
				A2(
				author$project$Playground$Components$column,
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Events$onClick(author$project$Playground$Types$ClearPlayground)
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$href('#'),
								elm$html$Html$Attributes$class('submenuLink')
							]),
						_List_fromArray(
							[
								...
								A2(
								elm$html$Html$span,
								author$project$Playground$Style$utf8Icon,
								_List_fromArray(
									[
										elm$html$Html$text('▼')
									])),
								...
								author$project$Playground$Components$row,
								_Utils_ap(
									author$project$Playground$Style$submenu,
									_List_fromArray(
										[
											A2(elm$html$Html$Attributes$style, 'position', 'absolute'),
											A2(elm$html$Html$Attributes$style, 'min-width', '150px'),
											A2(elm$html$Html$Attributes$style, 'margin', '5px 0 0 -10px'),
									...
									[
										...
										_List_fromArray(
											[
												...
												author$project$Playground$Types$SetExample(author$project$Playground$Types$Basics))
											]),
										_List_fromArray(
											[
												elm$html$Html$text('Basic Samples')
											])),
										A2(
										submenuItem,
										_List_fromArray(
											[
												elm$html$Html$Attributes$href('#'),
												elm$html$Html$Events$onClick(
												author$project$Playground$Types$SetExample(author$project$Playground$Types$Softmax))
											]),
										_List_fromArray(
											[
												elm$html$Html$text('Softmax')
											])),
										A2(
										submenuItem,
										_List_fromArray(
											[
												elm$html$Html$Attributes$href('#'),
												elm$html$Html$Events$onClick(
												author$project$Playground$Types$SetExample(author$project$Playground$Types$Bitcoin))
											]),
										_List_fromArray(
											[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$href('https://rogeriochaves.gitbooks.io/rubber/?'),
...
var author$project$Playground$about = function () {
	...
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[author$project$Playground$Components$header])),
			A2(
			author$project$Playground$Components$container,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					author$project$Playground$Components$row,
					_Utils_ap(
						author$project$Playground$Style$card,
						_List_fromArray(
							[
							...
							_List_fromArray(
								[
									...
									A2(
										...
										_List_fromArray(
											[
												elm$html$Html$Attributes$class('raw-math'),
												A2(elm$html$Html$Attributes$style, 'padding-bottom', '10px')
											]),
										_List_fromArray(
											[
...
var author$project$Playground$renderLatex = function (str) {
				...
				_List_fromArray(
					[
						...
						A2(
							...
							_List_fromArray(
								[
									elm$html$Html$text(convertedText)
								])))
					]))
			]));
};
var author$project$Encoder$encode = function (expr) {
	var encodeIdentifier = function (id) {
		if (id.$ === 'ScalarIdentifier') {
			var name = id.a;
			return name;
		} else {
			var name = id.a;
				...
				case 'Assignment':
					...
					switch (e1.$) {
						case 'Abstraction':
							return _Utils_ap(
								encodeIdentifier(id),
								author$project$Encoder$encode(e1));
						case 'MapAbstraction':
							return _Utils_ap(
								encodeIdentifier(id),
								author$project$Encoder$encode(e1));
						default:
							return encodeIdentifier(id) + (' = ' + author$project$Encoder$encode(e1));
					}
				case 'Application':
					var e0 = op.a;
					return author$project$Encoder$encode(e0) + ('(' + (author$project$Encoder$encode(e1) + ')'));
				case 'Sqrt':
	...
	var encodeDoubleOp = F3(
		function (op, e1, e2) {
			switch (op.$) {
				case 'Addition':
					return author$project$Encoder$encode(e1) + (' + ' + author$project$Encoder$encode(e2));
				case 'Subtraction':
					return author$project$Encoder$encode(e1) + (' - ' + author$project$Encoder$encode(e2));
				case 'Multiplication':
					return author$project$Encoder$encode(e1) + (' * ' + author$project$Encoder$encode(e2));
				case 'Division':
					return author$project$Encoder$encode(e1) + (' / ' + author$project$Encoder$encode(e2));
				case 'Exponentiation':
					var simple = author$project$Encoder$encode(e1) + (' ^ ' + author$project$Encoder$encode(e2));
					var complex = author$project$Encoder$encode(e1) + (' ^ {' + (author$project$Encoder$encode(e2) + '}'));
					switch (e2.$) {
						case 'Number':
							return simple;
						case 'Vector':
	...
	switch (expr.$) {
		...
		case 'SingleArity':
			var op = expr.a;
			var e = expr.b;
			return A2(encodeSingleOp, op, e);
		case 'DoubleArity':
			var op = expr.a;
			var e1 = expr.b;
			var e2 = expr.c;
			return A3(encodeDoubleOp, op, e1, e2);
		case 'TripleArity':
			var op = expr.a;
			var e1 = expr.b;
			var e2 = expr.c;
			var e3 = expr.d;
			var _var = op.a;
			return '\\sum_{' + (_var + (' = ' + (author$project$Encoder$encode(e1) + ('}^{' + (author$project$Encoder$encode(e2) + ('} ' + author$project$Encoder$encode(e3)))))));
		case 'Abstraction':
			var id = expr.a;
			var e = expr.b;
...
var author$project$Playground$Style$cellLabelOutput = _Utils_ap(
	...
	_List_fromArray(
		[
			A2(elm$html$Html$Attributes$style, 'color', '#D84315')
		]));
...
var author$project$Playground$renderResult = function (item) {
	var _n0 = item.result;
	if (_n0.$ === 'Just') {
		switch (_n0.a.$) {
			case 'Expression':
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							author$project$Playground$renderLatex(
							author$project$Encoder$encode(expr))
						]));
			case 'Error':
				var err = _n0.a.a;
				var row_ = err.row - 1;
				var msg = (row_ <= 0) ? elm$core$Debug$toString(err.problem) : ('Error on line ' + (elm$core$String$fromInt(row_) + (', column ' + (elm$core$String$fromInt(err.col) + (': ' + elm$core$Debug$toString(err.problem))))));
				return A2(
					author$project$Playground$Components$column,
					_Utils_ap(
				...
				[
					...
					_List_fromArray(
						[
							...
							(_Utils_eq(item.result, elm$core$Maybe$Nothing) || _Utils_eq(index, model.selectedCell)) ? A3(
							ohanhi$autoexpand$AutoExpand$view,
							A2(author$project$Playground$autoExpandConfig, 1, index),
							item.autoexpand,
							item.input) : author$project$Playground$renderLatex(item.input)
						])),
					author$project$Playground$renderResult(item)
				]));
	});
			...
			[
				...
				function () {
					...
					if (_n0.$ === 'Playground') {
						...
						return author$project$Playground$about;
					}
				}()),
				A2(
				author$project$Playground$Components$container,
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$href('https://github.com/rogeriochaves/rubber/')
					]),
				_List_fromArray(
					[
						A2(
